define("gallery/backbone/1.0.0/backbone-debug", [ "gallery/underscore/1.4.4/underscore", "$" ], function(require, exports) {
    ...
    (function() {
        ...
        // Backbone.Router
        // ---------------
        // Routers map faux-URLs to actions, and fire events when action are
        // matched. Creating a new one sets its `action` hash, if not set statically.
        ...
        _.extend(Router.prototype, Events, {
            ...
            // Bind all defined action to `Backbone.history`. We have to reverse the
            // order of the action here to support behavior where the most general
            // action can be defined at the bottom of the route map.
        ...
        _.extend(History.prototype, Events, {
            ...
            // match, returns `true`. If no defined action matches the fragment,
            // returns `false`.
